...
class PropertyInsuranceService {
    ...
    {
        const INSURANCE_API_BASE_URL ="http://122.169.207.194:9092/api/notification/updateTheStatusForEmail/";
        return axios.put(INSURANCE_API_BASE_URL+customerId,data);
    }
    static upDateStatusForMobile(customerId,data)
    {
        const INSURANCE_API_BASE_URL ="http://122.169.207.194:9092/api/notification/updateTheStatusForMobile/";
        return axios.put(INSURANCE_API_BASE_URL+customerId,data);
    }

    static getAllDetailsOfMobile()
    {
        const INSURANCE_API_BASE_URL ="http://122.169.207.194:9092/api/notification/forMobile";
        return axios.get(INSURANCE_API_BASE_URL);
    }
    static getAllDetailsofEmail()
    {
        const INSURANCE_API_BASE_URL ="http://122.169.207.194:9092/api/notification/forEmail";
        return axios.get(INSURANCE_API_BASE_URL);
    }
    ...
    return axios.get(INSURANCE_API_BASE_URL);
     ...
     {
        const INSURANCE_API_BASE_URL=" http://122.169.207.194:9092/api/notification/findByCustomerIdForEmail/"+customerId;
        return axios.get(INSURANCE_API_BASE_URL);
     }
     static checkForEMobile(customerId)
     {
        const INSURANCE_API_BASE_URL=" http://122.169.207.194:9092/api/notification/findByCustomerIdForMobile/"+customerId;
        return axios.get(INSURANCE_API_BASE_URL);
     }
}
