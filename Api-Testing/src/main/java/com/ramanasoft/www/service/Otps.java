...
public class Otps 
{
	...
	public ResponseEntity<String> mobileOtp(String mobile) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body("OTP sent successfully for mobile"+otp);
    }
	
	
	// email otp for registration
	public ResponseEntity<String> emailOtp(String toEmail) {
	    ...
	    try {
	        ...
	        conn.setRequestProperty("Authorization", "Zoho-enczapikey PHtE6r0LFu3tjzEmp0VT4PS6Q5GtM996++5lfwcT444TW/EAG00D+Igrwz+1rRgvAfNKQPSdyNg8tezO5rnUdz67PG9OWWqyqK3sx/VYSPOZsbq6x00Ys18Tc03VVILudtdt0iDRvtncNA==");

	        JSONObject requestBody = new JSONObject();
	        JSONObject from = new JSONObject();
	        String email = "welcome@qtnext.com";
	    ...
	    return ResponseEntity.status(HttpStatus.OK).body("Email otp sent successful for registratioin"+otp);
	}
	...
	public ResponseEntity<String> emailOtpForUpdation(String toEmail) {
	    String postUrl = "https://api.zeptomail.in/v1.1/email";
	    StringBuffer sb = new StringBuffer();
	    String otp = generateOTPforupdation();
	    ...
	    return ResponseEntity.status(HttpStatus.OK).body("Email otp sent successful for updation "+otp);
	}
	
	
	
	public ResponseEntity<String> quotEmail(String toEmail,String vnumber,String price,String idv,String premiumAmount)
	{
		String postUrl = "https://api.zeptomail.in/v1.1/email";
	    StringBuffer sb = new StringBuffer();
